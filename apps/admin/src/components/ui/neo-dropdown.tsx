...
export function NeoDropdown({ trigger, children, align = "right", className }: NeoDropdownProps) {
...
export function NeoDropdownItem({ onClick, children, className, variant = "default", icon, disabled }: NeoDropdownItemProps) {
    return (
        <button
...
export function NeoDropdownLabel({ children }: { children: React.ReactNode }) {
    return (
