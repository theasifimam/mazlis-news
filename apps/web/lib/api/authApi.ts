...
export const authApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // Bookmark Endpoints
        toggleBookmark: builder.mutation<{ success: boolean; message: string; data: { isBookmarked: boolean } }, string>({
            query: (articleId) => ({
        ...
        getBookmarks: builder.query<{ success: boolean; data: { bookmarks: any[] } }, void>({
            query: () => ({
