        ...
        <div className="min-h-screen bg-background text-foreground font-sans transition-colors duration-300 pb-24">
            ...
            <main className="flex flex-col items-center w-full">
                    ...
                    <div className="absolute bottom-24 left-6 right-6 md:left-12 md:right-12 flex flex-col gap-4 max-w-3xl">
                        ...
                        <div className="flex items-center gap-6 mt-2">
                            <div className="flex items-center gap-2 text-white/60">
                                ...
                                <span className="text-sm font-medium">{format(new Date(article.createdAt), 'MMM d, yyyy')}</span>
                            </div>
                            <div className="flex items-center gap-2 text-white/60">
                                <Eye size={16} className="shrink-0" />
                                <span className="text-sm font-medium">{article.readCount?.toLocaleString() || 0} Reads</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div className="relative w-full bg-background rounded-t-[2.5rem] md:rounded-t-[4rem] -mt-12 z-30 pt-10 flex flex-col items-center">
                    <div className="w-full max-w-4xl px-6 flex flex-row items-center justify-between gap-4 pb-8 mb-4">
                        <Link
                        ...
                        <div className="flex items-center gap-4 shrink-0">
                            <div className="shrink-0">
                                <BookmarkButton articleId={article._id} className="!bg-zinc-100 dark:!bg-zinc-800 !text-zinc-400 hover:!text-zinc-900 dark:hover:!text-white !h-10 !w-10 !flex !items-center !justify-center !p-0 !border-none !shadow-none" />
                            </div>
                        </div>
                    </div>
