                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mb-20">
                                {[1, 2, 3].map((i) => (
                                    <div key={i} className="flex flex-col gap-4 animate-pulse">
                                        <div className="aspect-[4/3] w-full bg-zinc-100 dark:bg-zinc-900 rounded-[2.5rem]" />
                                        <div className="h-4 w-1/4 bg-zinc-100 dark:bg-zinc-900 rounded-full" />
                                        <div className="h-8 w-full bg-zinc-100 dark:bg-zinc-900 rounded-2xl" />
                                    </div>
                                ))}
                            </div>
                        ) : (
